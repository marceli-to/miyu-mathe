<div class="space-y-8">
    ...
    <div class="bg-white rounded-2xl border border-stone-200 p-6 md:p-8">
        <h2 class="text-2xl font-semibold text-stone-900 mb-2">Zuviele Klammern</h2>
        <p class="text-stone-600">Diese Rechnungen haben zu viele Klammern. Schreibe sie mit nur den notwendigen Klammern auf und berechne das Resultat.</p>
    </div>
                ...
                <div class="border-b-2 border-b-stone-200 pb-5">
                    ...
                    <div class="ml-12 flex flex-col md:flex-row md:items-center gap-3">
                        <div class="flex items-center gap-2">
                            <span class="text-stone-500 text-sm">Vereinfacht:</span>
                            <input
                                type="text"
                                wire:model="answers.{{ $index }}.simplified"
                                class="w-64 h-10 px-3 text-lg font-mono border-2 rounded-lg focus:outline-none transition-colors border-stone-300 focus:border-terracotta-500"
                                placeholder="z.B. 3 × 4 + 2"
                            >
                        </div>
                        <div class="flex items-center gap-2">
                    ...
                    @if($showResults && !$results[$index]['resultCorrect'])
                        <div class="ml-12 mt-2 text-sm text-stone-500">
                            Vereinfacht: <span class="font-mono">{{ $exercise['simplified'] }}</span>
                        </div>
                    @endif
                </div>
            @endforeach
